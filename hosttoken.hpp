...
namespace eosio {
   ...
   class [[eosio::contract("hosttoken")]] hosttoken : public contract {
      public:
         ...
         [[eosio::action]]
         void addmethod(name username, name type, name detail_type, asset token, std::string details);
         
         [[eosio::action]]
         void rmmethod(name username, uint64_t id);

         [[eosio::action]]
         void setachange(name username, uint64_t method_id, bool status);         
      ...
      private:
         ...
         struct [[eosio::table]] methods {
            ...
            uint64_t bydtype() const {return detail_type.value;}
         ...
         typedef eosio::multi_index< "methods"_n, methods,
            ...
            eosio::indexed_by<"bydtype"_n, eosio::const_mem_fun<methods, uint64_t, &methods::bydtype>>
